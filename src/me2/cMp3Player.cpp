...
cMp3Player::cMp3Player(cMp3Player* param_1) {
}

/* 100076d0-100076f7 00027	*/
cMp3Player* cMp3Player::operator=(cMp3Player* param_1) {
	return 0;
}
...
void cMp3Player::Load(char* param_1) {
}
...
void cMp3Player::SetVolume(float param_1) {
}
