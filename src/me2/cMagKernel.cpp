...
void cMagKernel::RemoveObject(bool param_1) {

}

/* 10001200-1000131f 0011f	*/
cMagKernel::cMagKernel(cMagKernel* param_1) {

}

/* 10001460-100014b7 00057	*/
cMagKernel* cMagKernel::scalar_destructor(u8 param_1) {
...
void cMagKernel::OnInputMouse(f32 param_1, f32 param_2, bool param_3, bool param_4) {

}

/* 100114c0-100114fb 0003b	*/
D3DXVECTOR3* cMagKernel::GetPosition(D3DXVECTOR3* param_1) {

}

/* 10011500-1001151e 0001e	*/
D3DXMATRIX* cMagKernel::GetWorldMat(D3DXMATRIX* param_1) {

}

/* 10011520-100115be 0009e	*/
D3DXMATRIX* cMagKernel::GetTransformMatrix(D3DXMATRIX* param_1) {
...
void cMagKernel::SetObjectName(char* param_1) {

}

/* 10011600-1001160d 0000d	*/
void cMagKernel::SetObjectID(i32 param_1) {

}

/* 10011610-10011617 00007	*/
i32 cMagKernel::GetObjectID() {
...
void cMagKernel::InitOnInputMouseHandlerParam(f32 param_1, f32 param_2, bool param_3, bool param_4) {
...
void cMagKernel::OnChangeMovement(i32 param_1) {
...
D3DXMATRIX* cMagKernel::GetRotMat(D3DXMATRIX* param_1) {
...
bool cMagKernel::OnProcessStateMachine(StateObject_Str* param_1, i32 param_2, MsgObject* param_3) {
...
void cMagKernel::OnMouseArrive(i32 param_1) {

}

/* 10011c80-10011d04 00084	*/
void cMagKernel::OnMouseLeave(i32 param_1) {

}

/* 10011d10-10011d94 00084	*/
void cMagKernel::OnMouseEnter(i32 param_1) {
...
void cMagKernel::OnDestTime(f32 param_1) {
...
void cMagKernel::SetObjectParam(i32 param_1) {

}

/* 10012450-10012454 00004	*/
i32 cMagKernel::GetObjectParam() {

}

/* 10012460-10012463 00003	*/
void cMagKernel::Load() {
...
void cMagKernel::CallOnInputMouse(f32 param_1, f32 param_2, bool param_3, bool param_4) {
...
void cMagKernel::CallOnDestTime(f32 param_1) {
...
void cMagKernel::CallOnBonePositionUpdate(u32 param_1, u32 param_2, u32 param_3, u32 param_4, u8 param_5, u8 param_6, u8 param_7, u8 param_8, u8 param_9, u8 param_10) {
...
void cMagKernel::CallOnMouseEnter(i32 param_1) {

}

/* 100127c0-100127e9 00029	*/
void cMagKernel::CallOnMouseLeave(i32 param_1) {

}

/* 100127f0-10012819 00029	*/
void cMagKernel::CallOnMouseArrive(i32 param_1) {
...
void cMagKernel::CallOnDestinationPos(u32 param_1, u32 param_2, u32 param_3) {

}

/* 100128c0-100128e3 00023	*/
void cMagKernel::CallOnChangeMovement(i32 param_1) {
