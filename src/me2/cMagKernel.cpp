...
void cMagKernel::SetObjectID(int param_1) {
}
...
void cMagKernel::CallOnBonePositionUpdate(uint param_1, uint param_2, uint param_3, uint param_4, uchar param_5, uchar param_6, uchar param_7, uchar param_8, uchar param_9, uchar param_10) {
}
...
void cMagKernel::CallOnDestinationPos(uint param_1, uint param_2, uint param_3) {
}
