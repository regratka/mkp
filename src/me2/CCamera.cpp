...
void CCamera::SetDirection(D3DXVECTOR3 param_1) {
	...
	if (isFreeRotationMatrix) {
		...
		if (param_1.x == 0.0f && param_1.z == 0.0f && (param_1.y == 1.0f || param_1.y == -1.0f)) {
			Dstack_70 = GetRight();
		} else {
			Dstack_70 = D3DXVECTOR3(param_1.z-0.0f, 0.0f, 0.0f-param_1.x);
	...
	D3DXVECTOR3 Dstack_64 = GetDirection();
