...
private:
	struct SubSpriteData {
		...
		/* 0x64  */ RECT unk_64;
		/* 0x74  */ float unk_74;
		/* 0x78  */ uchar field_0x78[0x17b - 0x78];
...
private:
	/* 0xd4c  */ uchar field_0xd4c[0xd4d - 0xd4c];
	/* 0xd4d  */ bool unk_d4d;
	/* 0xd50  */ int srcBlend;
	/* 0xd54  */ int destBlend;
	...
	/* 0xd6c  */ uchar field_0xd6c[0xd84 - 0xd6c];
	/* 0xd84  */ D3DXVECTOR3 scale;
	/* 0xd90  */ uchar field_0xd90[0xdd8 - 0xd90];
	...
	/* 0x14cc */ uchar field_0x14cc[0x1660 - 0x14cc];
	...
	/* 0x1728 */ float moviewScaleX;
	/* 0x172c */ float moviewScaleY;
	/* 0x1730 */ uchar field_0x1730[0x1734 - 0x1730];
