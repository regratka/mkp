...
public:
	...
	/* 1009B230 */ HRESULT Play(ulong param_1, IDirectMusicAudioPath8* param_2);
	/* 1009B290 */ HRESULT Download(IDirectMusicAudioPath8* param_1);
	/* 1009B2E0 */ HRESULT Unload(IDirectMusicAudioPath8* param_1);
	/* 1009B330 */ HRESULT SetVolume(int param_1, IDirectMusicAudioPath8* param_2);
	/* 1009B3A0 */ int IsPlaying();
	/* 1009B3D0 */ HRESULT Stop(ulong param_1);
	/* 1009B400 */ HRESULT SetRepeats(ulong param_1);
	/* 1009B420 */ HRESULT GetStyle(IDirectMusicStyle8** param_1, ulong param_2);
