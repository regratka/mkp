...
public:
	...
	/* 0x1dda */ uchar field_0x1dda[0x2548 - 0x1dda];
	/* 0x2548 */ BOOL unk_2548;
	/* 0x254c */ BOOL unk_254c;
	/* 0x2550 */ uchar field_0x2550[0x276c - 0x2550];
	/* 0x276c */ int unk_276c;
	/* 0x2770 */ uchar field_0x2770[0x278c - 0x2770];
